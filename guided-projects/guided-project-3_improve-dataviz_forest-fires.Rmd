...
This plot illustrates adjusting figure sizing and aspect ratio. The chunk options are specified as:
````
```{r, fig.width = 6, fig.asp = 0.618, out.width = "70%", fig.align = "center"}
# ggplot code here
```
...
Because this document renders to Markdown, the `fig.align` option is not effective. However, it is useful when rendering to HTML or PDF formats.

```{r, fig.width = 6, fig.asp = 0.618, out.width = "70%"}
forestfires_long |>
